...
func createTestNodeAdapter() TreeAdapter[TestNode] {
	return TreeAdapter[TestNode]{
...
func createTestCategoryAdapter() TreeAdapter[TestCategory] {
	return TreeAdapter[TestCategory]{
...
func TestBuildTree(t *testing.T) {
	...
	t.Run("works with different data types", func(t *testing.T) {
		...
		result := BuildTree(categories, categoryAdapter)
...
func TestFindTreeNode(t *testing.T) {
	...
	t.Run("finds root node", func(t *testing.T) {
		nodes := createTestNodes()
		tree := BuildTree(nodes, adapter)

		result, found := FindTreeNode(tree, "1", adapter)
	...
	t.Run("finds deep nested node", func(t *testing.T) {
		...
		result, found := FindTreeNode(tree, "f", adapter)
	...
	t.Run("finds leaf node", func(t *testing.T) {
		...
		result, found := FindTreeNode(tree, "4", adapter)
	...
	t.Run("finds intermediate node", func(t *testing.T) {
		...
		result, found := FindTreeNode(tree, "2", adapter)
	...
	t.Run("returns false for non-existent node", func(t *testing.T) {
		...
		result, found := FindTreeNode(tree, "nonexistent", adapter)
	...
	t.Run("returns false for empty target ID", func(t *testing.T) {
		...
		result, found := FindTreeNode(tree, constants.Empty, adapter)
	...
	t.Run("finds node in different tree branches", func(t *testing.T) {
		...
		result1, found1 := FindTreeNode(tree, "2", adapter)
		assert.True(t, found1)
		assert.Equal(t, "2", result1.Id)

		// Find node in second branch
		result2, found2 := FindTreeNode(tree, "7", adapter)
		assert.True(t, found2)
		assert.Equal(t, "7", result2.Id)

		// Find orphan node
		result3, found3 := FindTreeNode(tree, "8", adapter)
	...
	t.Run("works with different data types", func(t *testing.T) {
		...
		categoryAdapter := createTestCategoryAdapter()
		tree := BuildTree(categories, categoryAdapter)

		result, found := FindTreeNode(tree, "ai", categoryAdapter)
...
func TestFindTreeNodePath(t *testing.T) {
	adapter := createTestNodeAdapter()
	...
	t.Run("finds path to root node", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "1", adapter)
	...
	t.Run("finds path to deep nested node", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "f", adapter)
	...
	t.Run("finds path to immediate child", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "2", adapter)
	...
	t.Run("finds path to leaf node", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "4", adapter)
	...
	t.Run("finds path to orphan node", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "8", adapter)
	...
	t.Run("returns empty path for non-existent node", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "nonexistent", adapter)
	...
	t.Run("returns empty path for empty target ID", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, constants.Empty, adapter)
	...
	t.Run("finds path in different tree branches", func(t *testing.T) {
		...
		path1, found1 := FindTreeNodePath(tree, "5", adapter)
		assert.True(t, found1)
		...
		path2, found2 := FindTreeNodePath(tree, "7", adapter)
		assert.True(t, found2)
	...
	t.Run("works with different data types", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "ai", categoryAdapter)
	...
	t.Run("finds path with multiple possible paths", func(t *testing.T) {
		...
		path, found := FindTreeNodePath(tree, "g", adapter)
...
func TestTreeAdapter_EdgeCases(t *testing.T) {
	t.Run("adapter with nil functions panics appropriately", func(t *testing.T) {
		...
		badAdapter := TreeAdapter[TestNode]{
			GetId:       nil,
			GetParentId: nil,
			GetChildren: nil,
			SetChildren: nil,
	...
	t.Run("memory safety with concurrent access", func(t *testing.T) {
		...
		for i := range 10 {
			go func(id int) {
				...
				FindTreeNode(tree, "f", adapter)
				FindTreeNodePath(tree, "g", adapter)
				FindTreeNode(tree, "root1", adapter)
...
func TestTreeAdapter_BenchmarkScenarios(t *testing.T) {
	t.Run("compares BuildTree efficiency vs naive approach", func(t *testing.T) {
